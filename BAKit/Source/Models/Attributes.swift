...
public struct Stock {
    var dateBorn: Date?
    var dateLocationPermissionRequested:Date? = UserDefaults.init(suiteName: "BAKit")?.object(forKey: "dateLocationPermissionRequested") as? Date
    var dateNotificationPermissionRequested:Date? = UserDefaults.init(suiteName: "BAKit")?.object(forKey: "dateNotificationPermissionRequested") as? Date
    var email: String?
    var facebookUrl: String?
    var gender: String?
    var instagramUrl: String?
    var linkedInUrl: String?
    var locationPermission: Bool? = UserDefaults.init(suiteName: "BAKit")?.bool(forKey: "locationPermission") ?? false
    var name: String?
